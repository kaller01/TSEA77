...
NEXT_LETTER:
	...
	//LEAVE SPACE
	cpi		r16, ' '
	brne	NEXT_LETTER_continue
	ldi		r16, 'A'-1
NEXT_LETTER_continue:
	inc		r16
	//LIMIT
	cpi		r16,'Z'+1
	brne	NEXT_LETTER_done
	ldi		r16, 'A'
NEXT_LETTER_done:
	st		Z, r16
	call	LETTER_PRINT
...
PREVIOUS_LETTER:
	...
	//LEAVE SPACE
	cpi		r16, ' '
	brne	PREVIOUS_LETTER_continue
	ldi		r16, 'Z'+1
PREVIOUS_LETTER_continue:
	dec		r16
	//LIMIT
	cpi		r16,'A'-1
	brne	PREVIOUS_LETTER_done
	ldi		r16, 'Z'
PREVIOUS_LETTER_done:
	st		Z, r16
	call	LETTER_PRINT
	ret
